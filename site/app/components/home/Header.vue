...
<template>
  <header v-if="props.content" class="header tete">
    ...
    <FlexContainer layout="row" contentJustify="start" itemsAlign="start" class="flex-container-custom">
      <Button to="/blog" isLink text="Read Blogs" colourPrimary="#e6b376" colourSecondary="#101d2c" class="btn-test" />
      <Button to="/projects" isLink isExternal text="View Projects" colourPrimary="#e6b376" colourSecondary="#101d2c"
        class="btn-test" />
    </FlexContainer>
  </header>
</template>
