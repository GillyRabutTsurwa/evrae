...
<template>
  <section class="intro landing">
    ...
    <p class="intro__paragraph">
      ...
      I
      never thought nor dreamed that I
      would ever be a web developer, much less have any affinity or interest in code. But after my 1st ever computer
      science course in 2017, which was
      a Java course, I continued on (even though I never became a programmer afterwards). I shortly took a HTML course
      shortly after, things more than
      less stuck well and I eventually became a web developer. In my freetime, I work on my side projects, read, play
      football, play video-games and
      go on long drives to cool places, lakes, countrysides, national parks, etc. I also have a very active
      <a href="https://gilbertrabuttsurwa.blog" target="_blank" rel="noopener noreferrer" class="link__blog">blog</a>
      that I released very recently.
      All things said, it is a privilege to do what I do, and this is a career path — though it proved to be more than
      that — I am glad I stumbled upon.
    </p>
    <p class="intro__paragraph">
      ...
      full-stack applications. Such as my <a href="https://gilbertrabuttsurwa-shop.netlify.app/" target="_blank" rel="noopener noreferrer" class="link__blog">shop</a>, that I built with Node, Express and Sanity IO. The
